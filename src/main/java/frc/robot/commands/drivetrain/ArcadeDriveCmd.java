...
public class ArcadeDriveCmd extends Command {
    ...
    public ArcadeDriveCmd(DoubleSupplier doubleSupplier, DoubleSupplier doubleSupplier2, DoubleSupplier doubleSupplier3,
            Object object, boolean b, boolean c, SwerveSys swerveSys2) {
